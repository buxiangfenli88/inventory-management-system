            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control form-control-solid example-date-input @error('purchase_date') is-invalid @enderror"
                                ...
                                <div class="col-md-6">
                                    <label class="small my-1" for="supplier_id">Supplier <span
                                                class="text-danger">*</span></label>
                                    <select class="form-select form-control-solid @error('supplier_id') is-invalid @enderror"
                                            id="supplier_id" name="supplier_id" required>
                                        <option selected="" disabled="">Select a supplier:</option>
                                        @foreach ($suppliers as $supplier)
                                            <option value="{{ $supplier->id }}"
                                                    @if(old('supplier_id') == $supplier->id) selected="selected" @endif>{{ $supplier->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('supplier_id')
                                    <div class="invalid-feedback">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="form-group row align-items-center justify-content-between mt-2">
                                <div type="button" id="scanner"><i class="fa-solid fa-barcode"></i></div>
                            </div>
                            <!-- Form Row -->
                            <div class="row gx-3 mb-3">
                                <!-- Form Group (category) -->
                                <div class="col-md-5">
                                    <label class="small my-1" for="category_id">Category <span
                                                class="text-danger">*</span></label>
                                    <input type="hidden" id="scan_product_id">
                            ...
                            <div class="gx-3 table-responsive">
                                <table class="table align-middle">
                                    ...
                                    <tr class="table-primary">
                                        <td colspan="2"></td>
                                        <td>
                                            <input type="text" style="display: none" name="total_amount" value="0"
    ...
    <script id="document-template" type="text/x-handlebars-template">
        <tr class="delete_add_more_item" id="delete_add_more_item">
            ...
            <td style="display: none;">
                <input type="number" class="form-control unitcost" name="unitcost[]" value="0" required>
            </td>
            ...
            <td>
                <select class="form-select form-control" name="storage_location_id[]" required>
                    <option selected="" disabled="" value="">Chọn vị tri:</option>
                    @foreach ($storageLocations as $storageLocation)
                        <option value="{{ $storageLocation->id }}"
                                @if(old('storage_location_id') == $storageLocation->id) selected="selected" @endif>{{ $storageLocation->name }} ({{ $storageLocation->stock_remain }})</option>
                    @endforeach
                </select>
            </td>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on('keyup click', '.unitcost,.quantity', function () {
                var unitcost = $(this).closest("tr").find("input.unitcost").val() ?? 0;
    ...
    <script type="text/javascript">
        $(function () {
            $(document).on('change', '#category_id', function () {
                ...
                var scan_product_id = $('#scan_product_id').val();
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.each(data, function (key, v) {
                            html += '<option value="' + v.id + '" ' + (v.id == scan_product_id ? 'selected' : '') + ' > ' + v.product_name + '</option>';
                        });
