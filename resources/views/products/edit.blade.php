                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-solid @error('product_code') is-invalid @enderror" id="product_name" name="product_code" type="text" placeholder="" value="{{ old('product_code', $product->product_code) }}" autocomplete="off"/>
                            @error('product_code')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
