                    ...
                    <div class="invoice-info">
                        ...
                        <div class="row">
                            <div class="col-sm-6 mb-50">
                                <div class="invoice-number">
                                    ...
                                    <p class="invo-addr-1">
                                        {{ $supplier->created_at->timezone('+7')->format('d-m-Y H:i') }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 mb-50">
                                ...
                                <p class="inv-from-1">{{ $supplier->name }}</p>
                                <p class="inv-from-1">{{ $supplier->bien_so_xe }}</p>
{{--                                <p class="inv-from-1">{{ $order->customer->email }}</p>--}}
                                <p class="inv-from-2"><strong>Ghi chú: </strong></p>
                                <p class="inv-from-2">{{ $supplier->note }}</p>
                            </div>
                            <div class="col-sm-6 text-end mb-50">
                                <h4 class="inv-title-1">Nhà Cung Cấp</h4>
                                <p class="inv-from-1">{{ $supplier->category->name ?? ''}}</p>
