...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/products/find-by-code', [ProductController::class, 'findByCode'])->name('products.findByCode');
    ...
    Route::get('/purchases/details/{purchase_id}/download', [PurchaseController::class, 'downloadPurchases'])->name('purchases.downloadPurchases');
    ...
    // User Management
    Route::resource('/users', UserController::class)->except(['show'])->middleware('role:' . UserRole::ADMIN);
